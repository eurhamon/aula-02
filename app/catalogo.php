...
function carregarProdutos() {
    $produtos = [
        ...
        [
            'id' => 5,
            'nome' => 'Câmera DSLR EOS',
            'imagem' => 'images/01EOS.jpg',
            'descricao' => 'Capture momentos incríveis com qualidade profissional e lentes intercambiáveis.',
            'preco' => 4599.50,
            'avaliacao' => 5
        ],
        [
